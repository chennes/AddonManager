...
class TestVersion(unittest.TestCase):
    ...
    def test_is_osi_approved(self):
        ...
        for license_to_test in some_approved_licenses:
            self.assertTrue(manager.is_osi_approved(license_to_test), f"{license_to_test} was rejected")
        for license_to_test in some_unapproved_licenses:
            self.assertFalse(manager.is_osi_approved(license_to_test), f"{license_to_test} was accepted")
    ...
    def test_is_fsf_approved(self):
        ...
        for license_to_test in some_approved_licenses:
            self.assertTrue(manager.is_fsf_libre(license_to_test), f"{license_to_test} was rejected")
        for license_to_test in some_unapproved_licenses:
            self.assertFalse(manager.is_fsf_libre(license_to_test), f"{license_to_test} was accepted")
